...
namespace SistemaBookShare.dao
{
    internal class DUsuario
    {
        ...
        public DUsuario()
        {
            connectionString = ConfigurationManager.ConnectionStrings["SistemaBookShare.Properties.Settings.Conexion"].ConnectionString;
        }

        // Metodo para listar los usuarios

        //crea metodo para guardarUsuario en la base de datos
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand())
                    {
                        ...
                        command.CommandText = "INSERT INTO Tbl_Usuario (nombre, nombreUsuario, pw, fechaCreacion, estado, idRol) " +
                            "VALUES (@nombre, @nombreUsuario, @pw, @fechaCreacion, @estado, @idRol)";
